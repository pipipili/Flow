...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_DIARYS =
            "create table Diarys ("
                    ...
                    + "moodtype integer NOT NULL default -1)";

    public static final String CREATE_BINS =
            "create table Bins ("
                    + "diaryId integer PRIMARY KEY autoincrement,"
                    + "title VARHAR(30) NOT NULL,"
                    + "content TEXT NOT NULL,"
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_BINS);
        Toast.makeText(mContext, "Create succeeded", Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("drop table if exists Diarys");
