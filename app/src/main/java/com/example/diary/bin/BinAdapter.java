...
public class BinAdapter extends ArrayAdapter {
    private int resourceId;

    public BinAdapter(Context context, int textViewResourceId, List<diary> objects){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            viewHolder.diaryTimeWeek = (TextView) view.findViewById(R.id.bin_time_week);
            viewHolder.diaryTime = (TextView) view.findViewById(R.id.bin_time);
            viewHolder.diaryTitle = (TextView) view.findViewById(R.id.bin_title);
