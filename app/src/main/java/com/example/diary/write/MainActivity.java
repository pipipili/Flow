...
//        listView.setAdapter(adapter);
        ...
        initDiarys();   //初始化日记数据
        DiaryAdapter adapter = new DiaryAdapter(MainActivity.this,R.layout.write_card, diaryList);
        ListView listView = (ListView) findViewById(R.id.list_view);
        listView.setAdapter(adapter);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.add:
                Intent intent_button = new Intent(MainActivity.this,ButtonActivity.class);
        ...
        confirm.setPositiveButton("确定",new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(cursor.moveToFirst()) {
                    ...
                    String author = cursor.getString(cursor.getColumnIndex("author"));
                    String showTime = cursor.getString(cursor.getColumnIndex("showTime"));
                    //int q = cursor.getInt(cursor.getColumnIndex("moodType"));
